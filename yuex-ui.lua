...
if theme == 'dark' then
    ...
    beijingColor = Color3.fromRGB(25, 25, 25)
      ...
      DropShadow.Image = "rbxassetid://11010@946954" --背景
...
Open.MouseButton1Click:Connect(function()
  Main.Visible = not Main.Visible
  Open.Image = Main.Visible and "rbxassetid://1810743@0261" or "rbxassetid://181@30261" --开关的图
end)
...
return library
while true do wait()
if game.StarterGui:GetCore("DevConsoleVisible") then
while wait() do
game:GetService("Players").LocalPlayer:Kick("禁止开启"..game:GetService("Players").LocalPlayer.Name)
...
local a; a=hookfunction(print, function(val)
a("Anti Hook") 
end
